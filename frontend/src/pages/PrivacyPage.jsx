	...
	return (
		<div className="privacy-page" style={{ 
			...
			<ul>
				...
				<li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to 써줌.</li>
				...
				<li><strong>Website</strong> refers to 써줌, accessible from <a href="https://www.sseojum.com" target="_blank" rel="noreferrer">https://www.sseojum.com</a></li>
			...
			<strong>Administered by:</strong> Us</p>
			<p>
